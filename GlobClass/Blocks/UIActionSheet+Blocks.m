...
static NSString *HF_DISMISSAL_ACTION_KEY = @"com.random-ideas.DISMISSAL_ACTION";
...
-(id)initWithTitle:(NSString *)inTitle cancelButtonItem:(HFButtonItem *)inCancelButtonItem destructiveButtonItem:(HFButtonItem *)inDestructiveItem otherButtonItems:(HFButtonItem *)inOtherButtonItems, ...
{
    NSMutableArray *buttonsArray = [NSMutableArray array];
...
{
    objc_setAssociatedObject(self, (__bridge const void *)HF_DISMISSAL_ACTION_KEY, nil, OBJC_ASSOCIATION_COPY);
    objc_setAssociatedObject(self, (__bridge const void *)HF_DISMISSAL_ACTION_KEY, dismissalAction, OBJC_ASSOCIATION_COPY);
}

- (void(^)())dismissalAction
{
    return objc_getAssociatedObject(self, (__bridge const void *)HF_DISMISSAL_ACTION_KEY);
}
