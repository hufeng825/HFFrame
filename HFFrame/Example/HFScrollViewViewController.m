...
- (void)viewDidLoad
{
	...
	[picArray addObject:@"http://img.my.csdn.net/uploads/201101/25/3619941_1295933580js8j.jpg"];
	[picArray addObject:@"http://img.my.csdn.net/uploads/201101/25/3619941_1295933551y8U4.jpg"];
	[picArray addObject:@"http://img.my.csdn.net/uploads/201101/25/3619941_1295933464VGk8.jpg"];
    [picArray release];
...
//		[manager downloadWithURL: delegate:self];
	...
	self.cycleScrollView =[ [CycleScrollView alloc ]initWithFrame:self.view.frame cycleDirection:CycleDirectionLandscape picturesUrl:picArray TimeInterval:3];
